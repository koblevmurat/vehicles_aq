...
public class ResponseService implements IResponseService {
    ...
    @Override
    public void UpdateDocStatus(DocStatusDto docStatusDto) throws URISyntaxException, IOException, InterruptedException {
        this.responseRepository.UpdateDocument(mapDocStatus(docStatusDto));
    }
